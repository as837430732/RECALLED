...
class MultimodalImageAttackTrainer:
        ...
        for epoch in range(epochs):
            ...
            for batch_idx in tqdm(range(num_batches), desc=f"Epoch {epoch+1}"):
                ...
                try:
                    ...
                    adversarial_pixel_values, perturbations = self.generator.generate_adversarial_pixel_values(
                        images=batch_images,
                        texts=batch_orig,
                    ...
                    original_inputs = self.generator.prepare_multimodal_inputs(batch_images, batch_orig, target_labels=[])
                 
                    success_rate, responses = self.generator.evaluate_adversarial_attack(
                        adversarial_pixel_values, original_inputs, batch_orig, batch_labels
                    )
                    ...
                    if batch_success_rate >= best_success_rate:
                        ...
                        best_adversarial_pixel_values = adversarial_pixel_values.clone()
                      
                        
                        self.save_best_adversarial_results(
    ...
    def record_batch_results(self, epoch, batch_idx, success_rate, log_path):
